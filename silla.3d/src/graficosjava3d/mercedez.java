...
public final class mercedez extends Applet {
    private static final long serialVersionUID = 1L;
    
    public static void main(String[] args){
        if (args.length>=1)
            new MainFrame(new mercedez(args[0]),1250,1000);
        else
            new MainFrame(new mercedez(null),1250,1000);
    }
    
    public mercedez (String filename){
        //se crea el universo
    ...
    public BranchGroup crearescenaG(String filename){
        ...
        try{
           s = file.load(filename == null ? "src\\images\\mercedez.obj" : filename);
    ...
    private TransformGroup dibujarfondo(){
        ...
        TextureLoader espacio = new TextureLoader("src/images/fondomercedez.jpg",this);
