...
public final class nike extends Applet {
    private static final long serialVersionUID = 1L;
    
    public static void main(String[] args){
        if (args.length>=1)
            new MainFrame(new nike(args[0]),1250,1000);
        else
            new MainFrame(new nike(null),1250,1000);
    }
    
    public nike (String filename){
        //se crea el universo
    ...
    public BranchGroup crearescenaG(String filename){
        ...
        try{
           s = file.load(filename == null ? "src\\images\\tenis.obj" : filename);
    ...
    private TransformGroup dibujarfondo(){
        ...
        TextureLoader espacio = new TextureLoader("src/images/fondonike.jpg",this);
