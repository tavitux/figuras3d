...
public final class tvantiguo extends Applet {
    private static final long serialVersionUID = 1L;
    
    public static void main(String[] args){
        if (args.length>=1)
            new MainFrame(new tvantiguo(args[0]),1250,1000);
        else
            new MainFrame(new tvantiguo(null),1250,1000);
    }
    
    public tvantiguo (String filename){
        //se crea el universo
    ...
    public BranchGroup crearescenaG(String filename){
        ...
        try{
           s = file.load(filename == null ? "src\\images\\tvviejo.obj" : filename);
    ...
    private TransformGroup dibujarfondo(){
        ...
        TextureLoader espacio = new TextureLoader("src/images/fondotvantiguo.jpg",this);
